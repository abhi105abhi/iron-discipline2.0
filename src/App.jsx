...
import { Shield, Flame, Lock, User, LayoutDashboard, BarChart3, Trash2, Edit3, Sword } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#050505] text-white p-4 pb-32 max-w-md mx-auto font-sans">
      <header className="flex justify-between items-center mb-10 p-2">
        <div className="flex items-center gap-3">
          <Shield className="text-blood-600 w-7 h-7 drop-shadow-[0_0_12px_rgba(220,38,38,0.7)]" />
          <h1 className="text-2xl font-black uppercase tracking-tighter italic">Iron<span className="text-blood-600">Discipline</span></h1>
        </div>
        <div className="bg-iron-800/40 p-1.5 rounded-full border border-iron-800 flex items-center gap-2 pr-4 shadow-inner">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blood-600 to-blood-800 flex items-center justify-center font-black text-xs shadow-lg">A</div>
        ...
        {activeTab === 'missions' ? (
          <>
            <section className="flex flex-col items-center my-6 bg-gradient-to-b from-iron-800/30 to-black p-12 rounded-[3.5rem] border border-iron-800/50 relative overflow-hidden">
               <div className="absolute top-6 right-8 text-[9px] font-black text-iron-700 tracking-widest uppercase italic">Combat Status</div>
               ...
               <div className="mt-8 text-center">
                 ...
                 <p className="text-[10px] text-iron-600 font-bold uppercase tracking-[0.4em] mt-3">Target: {completedToday}/{habits.length} Completed</p>
               </div>
            </section>

            <div className="flex justify-between items-end mb-8 px-5">
              <h2 className="text-[10px] font-black uppercase tracking-[0.5em] text-iron-700 italic border-b-2 border-blood-600/30 pb-1">Current Siege</h2>
